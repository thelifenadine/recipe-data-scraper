...
describe('MicrodataTransformer class', () => {
  let myClass;
  ...
  before(() => {
    myClass = proxyquire.noCallThru().load('./MicrodataTransformer', {
  ...
  describe('test response 1 (valid microdata)', () => {
    ...
    it('meta should be set to the response', () => {
      transformer.meta.should.eql(testResponse1);
    });

    it('recipeItem should be set to the recipe item in the response', () => {
      transformer.recipeItem.should.eql(testResponse1.items[0].properties);
    });
  });
  ...
  describe('test response 3 (valid microdata)', () => {
    ...
    it('meta should be set to the response', () => {
      transformer.meta.should.eql(testResponse3);
    });
    ...
    it('recipeItem should be set to the recipe item in the response', () => {
      transformer.recipeItem.should.eql(testResponse3.items[2].properties);
    });
  });
