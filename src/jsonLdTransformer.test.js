...
describe('JsonLdTransformer class', () => {
  let myClass;
  ...
  before(() => {
    myClass = proxyquire.noCallThru().load('./JsonLdTransformer', {
    }).default;
  });
  ...
  describe('test response 1', () => {
    ...
    before(async () => {
      transformer = new myClass(chtmlStub);
      transformer.meta = getMeta(testResponse1);
  ...
  describe('test response 2', () => {
    ...
    before(async () => {
      transformer = new myClass(chtmlStub);
      transformer.meta = getMeta(testResponse2);
      transformer.findRecipeItem();
    });
  ...
  describe('test response 3', () => {
    ...
    before(async () => {
      transformer = new myClass(chtmlStub);
      transformer.meta = getMeta(testResponse3);
      transformer.findRecipeItem();
    });
